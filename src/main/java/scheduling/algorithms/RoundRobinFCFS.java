...
/**
 * This class runs simulation for Round-Robin FCFS scheduling algorithm
 * @author Arkadiusz Maruszczak
 * @see BaseSchedulingAlgorithm
 *
 */
public class RoundRobinFCFS extends BaseSchedulingAlgorithm {
     ...
     *
     */
    public RoundRobinFCFS(String pathToSourceFile, double timeQuantum, boolean... isUnderTest) {
